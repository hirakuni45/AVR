...
#define SOCKWP		(0)			// for Micro SD interface at no write protect switch
#define SOCKINS		(!(PINB & 0x04))	/* Card detected.   yes:true, no:false, default:true */
...
//	PORTB = 0b10110000;
	PORTB |= 0b00111000;	/* Socket power off */
	DDRB  &= 0b00001111;
